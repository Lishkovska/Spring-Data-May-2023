package com.example.springdtoexercise;

import com.example.springdtoexercise.dto.*;
import com.example.springdtoexercise.service.GameService;
import com.example.springdtoexercise.service.UserService;
import com.example.springdtoexercise.service.UserServiceImpl;
...
public class ComandLineRunnerImpl implements CommandLineRunner {
    ...
    public ComandLineRunnerImpl(UserService userService, UserServiceImpl userServiceImpl,
        ...
        while (true) {
            ...
            switch (commandLine[0]) {
                case "RegisterUser" -> userService.registerUser
                        (new UserRegisterDto(commandLine[1], commandLine[2],
                                commandLine[3], commandLine[4]));
                case "LoginUser" -> userService.loginUser(new UserLoginDto(commandLine[1],
                        commandLine[2]));
