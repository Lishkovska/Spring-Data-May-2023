...
public class getMinionNames_03 {
    public static void main(String[] args) throws SQLException {
        ...
        PreparedStatement villainPrepStatement = connection.prepareStatement("select v.name  " +
                "from villains as v " +
                "where v.id = ? ;");
        ...
        PreparedStatement minionPrepStatement = connection.prepareStatement("select m.name , m.age " +
                "from minions as m " +
